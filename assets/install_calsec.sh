...
echo "2. Wait until the admin has added your user"
echo "3. Receive the sync data and signing fingerprint from the admin"
echo "4. Start CalSec from the Applications menu"
