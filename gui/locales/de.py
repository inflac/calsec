...
STRINGS = {
    ...
    "err_no_sign_keys":         "Fehler: Datei enthält keine Signierschlüssel.",
    ...
    "trust_sign_keys_title":    "Neue Signierschlüssel bestätigen",
    "trust_sign_keys_body":     "Die heruntergeladene Datei verwendet neue Signierschlüssel.\n\nErhalte den neuen Fingerprint vom Admin über einen separaten vertrauenswürdigen Kanal und gib ihn hier ein.\n\nEmpfangener Fingerprint:\n{fingerprint}",
    ...
    "fingerprint_will_change_hint": "Der Signatur-Fingerprint wird sich dabei ändern. Du musst den neuen Fingerprint danach an alle verbleibenden Nutzer über einen separaten vertrauenswürdigen Kanal weitergeben.",
    "fingerprint_redistribute_hint": "Der Signatur-Fingerprint hat sich geändert. Du musst den neuen Fingerprint an alle verbleibenden Nutzer über einen separaten vertrauenswürdigen Kanal weitergeben.",
    ...
    "fingerprint_rotated_hint": "Der Signatur-Fingerprint hat sich geändert. Gib diesen neuen Fingerprint an alle verbleibenden Nutzer über einen separaten vertrauenswürdigen Kanal weiter.\n\nBenutzer müssen ihn bestätigen, bevor sie wieder synchronisieren können.",
