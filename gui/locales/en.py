...
STRINGS = {
    ...
    "lbl_fingerprint_hint":     "Get this signing fingerprint from the admin over a separate trusted channel. It is required for the first calendar import.",
    ...
    "setup_done_fingerprint":   "Signing fingerprint:\n{fingerprint}\n\nShare this fingerprint with new users over a separate trusted channel.",
    ...
    "err_no_sign_keys":         "Error: File contains no signing keys.",
    ...
    "err_fingerprint_required": "Please enter the 64-hex signing fingerprint you received from the admin.",
    "err_fingerprint_mismatch": "Error: Signing fingerprint mismatch.\nReceived fingerprint:\n{fingerprint}",
    "trust_sign_keys_title":    "Confirm New Signing Keys",
    "trust_sign_keys_body":     "The downloaded file uses new signing keys.\n\nGet the new fingerprint from the admin over a separate trusted channel and enter it here.\n\nReceived fingerprint:\n{fingerprint}",
    ...
    "btn_copy_onboarding":      "Copy Onboarding",
    "col_email":                "Identifier",
    "col_role":                 "Role",
    "btn_remove":               "Remove",
    "btn_change_role":          "Change Role",
    "change_role_title":        "Change Role",
    "change_role_user":         "User: {identifier}",
    "change_role_current":      "Current role: {role}",
    "change_role_new":          "New role:",
    "role_changed_title":       "Role Changed",
    "role_changed_body":        "The role of '{label}' has been changed to '{role}'.",
    "fingerprint_will_change_hint": "The signing fingerprint will change if you continue. You must redistribute the new fingerprint to all remaining users over a separate trusted channel afterwards.",
    "fingerprint_redistribute_hint": "The signing fingerprint has changed. You must redistribute the new fingerprint to all remaining users over a separate trusted channel.",
    "hint_select_user":         "Please select a user first.",
    "err_sync_missing_onboarding": "Configure sync first before copying onboarding instructions.",
    "onboarding_copied_title":  "Onboarding Copied",
    "onboarding_copied_body":   "The onboarding text for '{identifier}' has been copied to the clipboard.",
    ...
    "date_picker_hint":         "Choose a date to jump directly to its month.",
    "col_date":                 "Date",
    "col_time":                 "Time",
    "col_title":                "Title",
    ...
    "fingerprint_title":        "Signing Fingerprint",
    "fingerprint_rotated_hint": "The signing fingerprint has changed. Share this new fingerprint with all remaining users over a separate trusted channel.\n\nUsers must confirm it before they can sync again.",
    "fingerprint_body":         "Share this fingerprint with new users over a separate trusted channel.\n\nUsers must compare it before the first calendar import.\n\n{fingerprint}",
    "fingerprint_copy_hint":    "Share this fingerprint with new users over a separate trusted channel.\n\nUsers must compare it before the first calendar import.",
